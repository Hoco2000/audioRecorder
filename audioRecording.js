...
import Postword from "../postWord/PostWord.js"
...
class RecordingAPI extends React.Component {
  constructor(props) {
    ...
    this.state = {
      recording: false,
      audios: [],
      audioRecorder: this.props.audioRecorded
    };
  }
    ...
    return (
      <div className="camera">
        ...
        <div id="flexRecord">
          ...
          {!recording && <button  id="record" onClick={e => this.startRecording(e)}> <span id="recordword"> Record </span> <div id="circle"> </div></button>}

          {recording && <button id="stop" onClick={e => this.stopRecording(e)}> <span id="recordword">Stop  </span></button>}
        </div>
        <div>
          <h3 id="recordList">Recorded audios: </h3>
